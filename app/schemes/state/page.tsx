      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-[#0A1931] text-white rounded-lg p-4 sm:p-5 mb-6">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-2">
            {getLabel("navigation.stateSchemes", language)}
          </h1>
          <p className="text-sm sm:text-base opacity-90">
            {getLabel("pages.schemes.stateSubtitle", language)}
          </p>
        </div>
        ...
        <section className="bg-white rounded-lg shadow-lg p-4 sm:p-5 mb-6">
          <h2 className="text-xl sm:text-2xl font-bold text-government-blue mb-3">
            {getLabel("pages.schemes.aboutStateSchemes", language)}
          </h2>
          <p className="text-gray-700 text-sm sm:text-base leading-relaxed">
            {getLabel("pages.schemes.stateIntro", language)}
          </p>
        </section>
              ...
              >
                <div className="bg-gradient-to-r from-orange-600 to-orange-800 text-white p-6">
                  <div className="flex items-start gap-4">
                    <FaFileAlt className="text-4xl sm:text-5xl flex-shrink-0" />
                    <div className="flex-1">
                      <h2 className="text-2xl sm:text-3xl font-bold mb-2">
                        {schemeName}
                      </h2>
                      <p className="text-sm sm:text-base opacity-80">
                        {getLabel("pages.schemes.stateGovernment", language)}
                      </p>
                    </div>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <div className="text-center">
              <p className="font-semibold">
                📞 {getText(helplineNumbers.state.label, language)}
              </p>
              <p className="text-lg">{helplineNumbers.state.number}</p>
            </div>
            <div className="text-center">
              <p className="font-semibold">
                🌐 {getLabel("pages.schemes.officialWebsite", language)}
              </p>
            ...
            <div className="text-center">
              ...
              <p className="text-lg">
                {getLabel("pages.schemes.monSat", language)}, 10 AM - 5 PM
              </p>
            </div>
          </div>
        </div>
